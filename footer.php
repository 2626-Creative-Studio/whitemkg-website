<footer>
  ...
  <div class="copyright">
    ...
    <p>&copy; copyright 2019. all rights reserved. <!--<a href="#">learn more</a> / <a href="#">view work</a>--></p>
    <div class="voffset40"></div>
  </div>
</footer>
...
<!-- Google maps -->
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDa-jjU99YKDYb0596i5wEWnVzQ3CGrN4s&callback=initMap" async defer></script>
<?php wp_footer(); ?>
</body></html>